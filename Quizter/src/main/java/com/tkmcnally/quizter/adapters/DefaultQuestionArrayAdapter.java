...
public class DefaultQuestionArrayAdapter extends ArrayAdapter {
    Activity context;
    ...
    public DefaultQuestionArrayAdapter(Activity context, int layoutId, int textId, int imageId, ArrayList<String> items) {
